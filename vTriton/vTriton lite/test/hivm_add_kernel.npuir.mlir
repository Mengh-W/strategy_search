...
func.func @add_kernel(%arg0: memref<?xf32, #hivm.address_space<gm>>,
  ...
  %src0 = memref.reinterpret_cast %arg0 to offset: [%c0], sizes: [1024], strides: [1]
      : memref<?xf32, #hivm.address_space<gm>>
      to memref<1024xf32, strided<[1], offset: ?>, #hivm.address_space<gm>>
  %src1 = memref.reinterpret_cast %arg1 to offset: [%c0], sizes: [1024], strides: [1]
      : memref<?xf32, #hivm.address_space<gm>>
      to memref<1024xf32, strided<[1], offset: ?>, #hivm.address_space<gm>>
  %dst = memref.reinterpret_cast %arg2 to offset: [%c0], sizes: [1024], strides: [1]
      : memref<?xf32, #hivm.address_space<gm>>
      to memref<1024xf32, strided<[1], offset: ?>, #hivm.address_space<gm>>
  ...
  hivm.hir.load ins(%src0 : memref<1024xf32, strided<[1], offset: ?>, #hivm.address_space<gm>>)
  ...
  hivm.hir.load ins(%src1 : memref<1024xf32, strided<[1], offset: ?>, #hivm.address_space<gm>>)
