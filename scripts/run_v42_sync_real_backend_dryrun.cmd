...
cd /d "%~dp0\.."
if "%~1"=="" (
  echo Usage: scripts\run_v42_sync_real_backend_dryrun.cmd path\to\hivm-operation-backend.exe [ir] [selected_plan] [output_dir]
  exit /b 2
)
set BACKEND=%~1
set IR_PATH=%~2
...
set OUT_DIR=%~4
if "%OUT_DIR%"=="" set OUT_DIR=artifacts\v42_sync_real_backend_dryrun
