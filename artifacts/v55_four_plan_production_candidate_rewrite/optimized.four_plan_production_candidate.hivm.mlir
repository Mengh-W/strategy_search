module {
  ...
  // HIVM V5.3 Four-Plan selected-parameter rewrite metadata end
    ...
    // HIVM V5.1 CVPipelinePlan slot binding: %k_ub -> %k_ub_mb2_ping (cvpipeline_true_rewrite_action_0000)
    ...
    scf.for %j = %c0 to %cE step %cB {   // @trip=10
      ...
      // HIVM V5.5 SyncPlan operation rewrite: normalized wait_flag pipe/event attrs from line 76
    ...
    // HIVM V5.1 CVPipelinePlan group end: cvpipeline_true_rewrite_action_0000
      ...
      // HIVM V5.5 SyncPlan operation rewrite: normalized set_flag pipe/event attrs from line 115
