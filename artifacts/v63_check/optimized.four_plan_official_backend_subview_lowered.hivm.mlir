module {
  ...
  func.func @fa(%Q_gm : memref<64x128xf16, #hivm.address_space<gm>>, %K_gm : memref<1024x128xf16, #hivm.address_space<gm>>, %V_gm : memref<1024x128xf16, #hivm.address_space<gm>>, %O_gm : memref<64x128xf16, #hivm.address_space<gm>>) {
    ...
    %Q_gm_tile_v63_0 = memref.subview %Q_gm[%c0, %c0] [32, 128] [1, 1] : memref<64x128xf16, #hivm.address_space<gm>> to memref<32x128xf16, #hivm.address_space<ub>>
    hivm.hir.load ins(%Q_gm_tile_v63_0 : memref<32x128xf16, #hivm.address_space<ub>>) outs(%q_ub_mb0_ping : memref<32x128xf16, #hivm.address_space<ub>>)
      ...
      scf.for %k_outer = %c0 to %cK step %c128 {   // HIVM V5.6 TilingPlan K-tile loop
        scf.for %n_outer = %c0 to %cN step %c64 {   // HIVM V5.6 TilingPlan N-tile loop
          scf.for %j = %c0 to %cE step %cB {   // @trip=10
            %K_gm_tile_v63_1 = memref.subview %K_gm[%n_outer, %k_outer] [64, 128] [1, 1] : memref<1024x128xf16, #hivm.address_space<gm>> to memref<64x128xf16, #hivm.address_space<ub>>
            hivm.hir.load ins(%K_gm_tile_v63_1 : memref<64x128xf16, #hivm.address_space<ub>>) outs(%k_ub : memref<64x128xf16, #hivm.address_space<ub>>)
            %V_gm_tile_v63_2 = memref.subview %V_gm[%n_outer, %c0] [64, 128] [1, 1] : memref<1024x128xf16, #hivm.address_space<gm>> to memref<64x128xf16, #hivm.address_space<ub>>
            hivm.hir.load ins(%V_gm_tile_v63_2 : memref<64x128xf16, #hivm.address_space<ub>>) outs(%v_ub : memref<64x128xf16, #hivm.address_space<ub>>)
    ...
    %O_gm_tile_v63_3 = memref.subview %O_gm[%c0, %c0] [32, 128] [1, 1] : memref<64x128xf16, #hivm.address_space<gm>> to memref<32x128xf16, #hivm.address_space<ub>>
    hivm.hir.store ins(%q_ub_mb0_ping : memref<32x128xf16, #hivm.address_space<ub>>) outs(%O_gm_tile_v63_3 : memref<32x128xf16, #hivm.address_space<ub>>)
    return
  }
}