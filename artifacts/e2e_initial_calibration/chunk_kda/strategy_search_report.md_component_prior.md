...
- 静态 max-live 近似：{'l0a': 0.0, 'l0b': 0.0, 'l0c': 120.0, 'l1': 132.0, 'ub': 213.94} KB
...
## 4. 寻优结果与优化前后对比
- 当前输入 IR 估计 predicted cycles：25247.39
- 最优候选 predicted cycles：20040.49
...
|---|---:|---:|---:|
| Predicted cycles | 25247.3932 | 20040.4935 | -5206.8998 |
| Tile 数量 | 4.0000 | 32.0000 | +28.0000 |
| Tile time | 4686.4970 | 1951.4879 | -2735.0091 |
| 同步 cost | 20063.0648 | 3206.1709 | -16856.8940 |
| 资源压力惩罚 | 220.0000 | 0.0000 | -220.0000 |
| Shape 惩罚 | 0.0000 | 45.0000 | +45.0000 |
| 合法性风险惩罚 | 277.8314 | 14837.8347 | +14560.0033 |
...
- Predicted tile_time=1951.49 cycles, n_tiles=32.
...
|---|---:|---:|---:|
| 并行化 tile cycles | 4686.50 | 1951.49 | -2735.01 |
| 每 tile 暴露 load | 1210.39 | 227.94 | -982.45 |
| Cube/Vector pipeline | 3596.62 | 575.14 | -3021.48 |
| 每 tile 暴露 store | 128.15 | 85.45 | -42.69 |
| 每 tile 暴露 GM workspace | 0.00 | 0.00 | +0.00 |
| GM workspace live bytes | 0.00 | 0.00 | +0.00 |
| warmup / drain | 114.33 | 23.25 | -91.08 |
| 同步 cost | 20063.06 | 3206.17 | -16856.89 |
| 资源压力惩罚 | 220.00 | 0.00 | -220.00 |
| shape 惩罚 | 0.00 | 45.00 | +45.00 |
| 合法性风险惩罚 | 277.83 | 14837.83 | +14560.00 |

## 7. Top 候选排行
| Rank | Strategy ID | Predicted cycles | Risk | Tile | DB | CV stage | Sync | DMA | Reuse | maxLive UB KB |
|---:|---|---:|---|---|---|---:|---|---|---|---:|
| 1 | candidate_00241 | 20040.49 | HIGH | (16,16,512) | True | 2 | graph_sync_solver | keep_existing | level1 | 24.25 |
| 2 | candidate_00277 | 20040.49 | HIGH | (16,16,512) | True | 2 | graph_sync_solver | keep_existing | level1 | 24.25 |
| 3 | candidate_00245 | 20040.62 | HIGH | (16,16,512) | True | 2 | graph_sync_solver | keep_existing | level1 | 24.25 |
| 4 | candidate_00281 | 20040.62 | HIGH | (16,16,512) | True | 2 | graph_sync_solver | keep_existing | level1 | 24.25 |
| 5 | candidate_00253 | 20043.43 | HIGH | (16,16,512) | True | 2 | graph_sync_solver | keep_existing | level1 | 24.25 |
| 6 | candidate_00257 | 20043.56 | HIGH | (16,16,512) | True | 2 | graph_sync_solver | keep_existing | level1 | 24.25 |
| 7 | candidate_00265 | 20049.30 | HIGH | (16,16,512) | True | 2 | graph_sync_solver | keep_existing | level1 | 24.25 |
| 8 | candidate_00269 | 20049.43 | HIGH | (16,16,512) | True | 2 | graph_sync_solver | keep_existing | level1 | 24.25 |
| 9 | candidate_00193 | 20062.44 | HIGH | (16,16,512) | True | 2 | graph_sync_solver | keep_existing | level1 | 24.25 |
| 10 | candidate_00229 | 20062.44 | HIGH | (16,16,512) | True | 2 | graph_sync_solver | keep_existing | level1 | 24.25 |
