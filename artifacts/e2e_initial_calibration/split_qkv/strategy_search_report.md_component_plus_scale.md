...
- 静态 max-live 近似：{'l1': 0.0, 'l0c': 0.0, 'ub': 107.78, 'l0b': 0.0, 'l0a': 0.0} KB
...
## 4. 寻优结果与优化前后对比
- 当前输入 IR 估计 predicted cycles：4502509.65
- 最优候选 predicted cycles：5664272.93
...
|---|---:|---:|---:|
| Predicted cycles | 4502509.6500 | 5664272.9320 | +1161763.2820 |
| Tile 数量 | 1340.0000 | 2680.0000 | +1340.0000 |
| Tile time | 120543.1969 | 81517.3017 | -39025.8953 |
| 同步 cost | 396793.0800 | 59253.9721 | -337539.1079 |
| 资源压力惩罚 | 7247.8744 | 7247.8744 | +0.0000 |
| Shape 惩罚 | 0.0000 | 0.0000 | +0.0000 |
| 合法性风险惩罚 | 0.0000 | 136111.8730 | +136111.8730 |
...
- Predicted tile_time=81517.30 cycles, n_tiles=2680.
...
|---|---:|---:|---:|
| 并行化 tile cycles | 4098468.70 | 5461659.21 | +1363190.52 |
| 每 tile 暴露 load | 35896.52 | 18764.47 | -17132.05 |
| Cube/Vector pipeline | 86920.82 | 46474.27 | -40446.54 |
| 每 tile 暴露 store | 3540.83 | 2979.61 | -561.22 |
| 每 tile 暴露 GM workspace | 0.00 | 0.00 | +0.00 |
| GM workspace live bytes | 0.00 | 0.00 | +0.00 |
| 同步 cost | 396793.08 | 59253.97 | -337539.11 |
| 资源压力惩罚 | 7247.87 | 7247.87 | +0.00 |
| shape 惩罚 | 0.00 | 0.00 | +0.00 |
| 合法性风险惩罚 | 0.00 | 136111.87 | +136111.87 |

## 7. Top 候选排行
| Rank | Strategy ID | Predicted cycles | Risk | Tile | DB | CV stage | Sync | DMA | Reuse | maxLive UB KB |
|---:|---|---:|---|---|---|---:|---|---|---|---:|
| 1 | candidate_00005 | 5664272.93 | HIGH | (16,64,512) | True | 1 | graph_sync_solver | keep_existing | level1 | 29.75 |
| 2 | candidate_00029 | 5664272.93 | HIGH | (16,64,512) | True | 1 | graph_sync_solver | keep_existing | level1 | 29.75 |
| 3 | candidate_00041 | 5664272.93 | HIGH | (16,64,512) | True | 1 | graph_sync_solver | keep_existing | level1 | 30.00 |
| 4 | candidate_00053 | 5664272.93 | HIGH | (16,64,512) | True | 1 | graph_sync_solver | keep_existing | level1 | 30.00 |
| 5 | candidate_00089 | 5664272.93 | HIGH | (16,64,512) | True | 1 | graph_sync_solver | keep_existing | level1 | 30.00 |
| 6 | candidate_00009 | 5667587.44 | HIGH | (16,64,512) | True | 1 | graph_sync_solver | keep_existing | level1 | 29.75 |
| 7 | candidate_00033 | 5667587.44 | HIGH | (16,64,512) | True | 1 | graph_sync_solver | keep_existing | level1 | 29.75 |
| 8 | candidate_00045 | 5667587.44 | HIGH | (16,64,512) | True | 1 | graph_sync_solver | keep_existing | level1 | 30.00 |
| 9 | candidate_00057 | 5667587.44 | HIGH | (16,64,512) | True | 1 | graph_sync_solver | keep_existing | level1 | 30.00 |
| 10 | candidate_00093 | 5667587.44 | HIGH | (16,64,512) | True | 1 | graph_sync_solver | keep_existing | level1 | 30.00 |
