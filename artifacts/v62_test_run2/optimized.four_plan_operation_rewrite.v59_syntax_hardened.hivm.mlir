module {
  ...
  func.func @fa(%Q_gm : memref<64x128xf16, #hivm.address_space<gm>>, %K_gm : memref<1024x128xf16, #hivm.address_space<gm>>, %V_gm : memref<1024x128xf16, #hivm.address_space<gm>>, %O_gm : memref<64x128xf16, #hivm.address_space<gm>>) {
    ...
    hivm.hir.set_flag {pipe="MTE2", event="EVENT_ID_CVP_L2C_0", producer_pipe="MTE2", consumer_pipe="V", hivm.v59_event_normalized=true}
      ...
      scf.for %k_outer = %c0 to %cK step %c128 {   // HIVM V5.6 TilingPlan K-tile loop
        scf.for %n_outer = %c0 to %cN step %c64 {   // HIVM V5.6 TilingPlan N-tile loop
          ...
          scf.for %j = %c0 to %cE step %cB {   // @trip=10
            ...
            hivm.hir.wait_flag {pipe="M", event="EVENT_ID0", producer_pipe="M", consumer_pipe="M", hivm.v59_event_normalized=true}
    ...
    // HIVM V5.8 CVPipeline stage binding: role=pipeline_sync_stage schedule=prologue/steady/epilogue distance=1
    hivm.hir.set_flag {pipe="V", event="EVENT_ID_CVP_C2S_0", producer_pipe="V", consumer_pipe="MTE3", hivm.v59_event_normalized=true}
    ...
    // HIVM V5.8 CVPipeline stage binding: role=pipeline_sync_stage schedule=prologue/steady/epilogue distance=1
    hivm.hir.wait_flag {pipe="MTE3", event="EVENT_ID_CVP_C2S_0", producer_pipe="V", consumer_pipe="MTE3", hivm.v59_event_normalized=true}
    ...
    // HIVM V5.1 CVPipelinePlan group end: cvpipeline_true_rewrite_action_0000
            ...
            // HIVM V5.8 CVPipeline stage binding: role=pipeline_sync_stage schedule=prologue/steady/epilogue distance=1
            hivm.hir.set_flag {pipe="MTE2", event="EVENT_ID_CVP_L2C_1", producer_pipe="MTE2", consumer_pipe="V", hivm.v59_event_normalized=true}
            ...
            // HIVM V5.8 CVPipeline stage binding: role=pipeline_sync_stage schedule=prologue/steady/epilogue distance=1
            hivm.hir.wait_flag {pipe="V", event="EVENT_ID_CVP_L2C_1", producer_pipe="MTE2", consumer_pipe="V", hivm.v59_event_normalized=true}
            // HIVM V5.8 CVPipeline stage binding: role=cube_compute_stage schedule=prologue/steady/epilogue distance=1
            ...
            // HIVM V5.8 CVPipeline stage binding: role=pipeline_sync_stage schedule=prologue/steady/epilogue distance=1
            hivm.hir.set_flag {pipe="V", event="EVENT_ID_CVP_C2S_1", producer_pipe="V", consumer_pipe="MTE3", hivm.v59_event_normalized=true}
            ...
            // HIVM V5.8 CVPipeline stage binding: role=pipeline_sync_stage schedule=prologue/steady/epilogue distance=1
            hivm.hir.wait_flag {pipe="MTE3", event="EVENT_ID_CVP_C2S_1", producer_pipe="V", consumer_pipe="MTE3", hivm.v59_event_normalized=true}
            ...
            hivm.hir.set_flag {pipe="FIX", event="EVENT_ID0", producer_pipe="FIX", consumer_pipe="FIX", hivm.v59_event_normalized=true}
          }
