...
func.func @chunk_kda_bwd_kernel_wy_dqkg_fused_opt_v2_mix_aiv(%arg0: i64 {hacc.arg_type = #hacc.arg_type<ffts_base_address>}, %arg1: memref<?xi8, #hivm.address_space<gm>> {hacc.arg_type = #hacc.arg_type<sync_block_lock>}, %arg2: memref<?xi8, #hivm.address_space<gm>> {hacc.arg_type = #hacc.arg_type<workspace>}, %arg3: memref<?xbf16, #hivm.address_space<gm>> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg4: memref<?xbf16, #hivm.address_space<gm>> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg5: memref<?xbf16, #hivm.address_space<gm>> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg6: memref<?xbf16, #hivm.address_space<gm>> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg7: memref<?xf32, #hivm.address_space<gm>> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg8: memref<?xf32, #hivm.address_space<gm>> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg9: memref<?xbf16, #hivm.address_space<gm>> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg10: memref<?xbf16, #hivm.address_space<gm>> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg11: memref<?xbf16, #hivm.address_space<gm>> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg12: memref<?xbf16, #hivm.address_space<gm>> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg13: memref<?xf32, #hivm.address_space<gm>> {tt.divisibility = 16 : i32, tt.tensor_kind = 1 : i32}, %arg14: memref<?xf32, #hivm.address_space<gm>> {tt.divisibility = 16 : i32, tt.tensor_kind = 1 : i32}, %arg15: memref<?xbf16, #hivm.address_space<gm>> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg16: memref<?xbf16, #hivm.address_space<gm>> {tt.divisibility = 16 : i32, tt.tensor_kind = 1 : i32}, %arg17: memref<?xf32, #hivm.address_space<gm>> {tt.divisibility = 16 : i32, tt.tensor_kind = 1 : i32}, %arg18: memref<?xf32, #hivm.address_space<gm>> {tt.divisibility = 16 : i32, tt.tensor_kind = 1 : i32}, %arg19: memref<?xf32, #hivm.address_space<gm>> {tt.divisibility = 16 : i32, tt.tensor_kind = 1 : i32}, %arg20: memref<?xi64, #hivm.address_space<gm>> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg21: memref<?xi64, #hivm.address_space<gm>> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg22: f32, %arg23: i32, %arg24: f32, %arg25: i32, %arg26: i32, %arg27: i32, %arg28: i32) attributes {SyncBlockLockArgIdx = 0 : i64, WorkspaceArgIdx = 1 : i64, func_dyn_memref_args = dense<[false, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, false, false, false, false, false, false, false]> : vector<29xi1>, hacc.entry, hacc.function_kind = #hacc.function_kind<DEVICE>, hivm.func_core_type = #hivm.func_core_type<AIV>, hivm.part_of_mix, hivm.storage_aligned, mix_mode = "mix", parallel_mode = "simd"} {
  ...
  // HIVM V5.0 MultiBufferPlan true rewrite: ping slot for %29 (multibuffer_true_rewrite_action_0000)
  %29_mb0_ping = hivm.hir.pointer_cast(%c148480_i64) : memref<64xi32, #hivm.address_space<ub>>
  annotation.mark %29_mb0_ping {hivm.multi_buffer_slot = "ping", hivm.rewrite_action = "multibuffer_true_rewrite_action_0000"} : none
  // HIVM V5.0 MultiBufferPlan true rewrite: pong slot for %29 (multibuffer_true_rewrite_action_0000)
  %29_mb0_pong = hivm.hir.pointer_cast(%c148480_i64) : memref<64xi32, #hivm.address_space<ub>>
  annotation.mark %29_mb0_pong {hivm.multi_buffer_slot = "pong", hivm.rewrite_action = "multibuffer_true_rewrite_action_0000"} : none
  // HIVM V5.0 MultiBufferPlan use replacement: producer %29 -> %29_mb0_ping (multibuffer_true_rewrite_action_0000)
  hivm.hir.varange offset[%c0] strides[%c1] outs(%29_mb0_ping : memref<64xi32, #hivm.address_space<ub>>)
  %30 = hivm.hir.pointer_cast(%c148480_i64) : memref<64xi32, #hivm.address_space<ub>>
  hivm.hir.pipe_barrier[<PIPE_V>]
  // HIVM V5.0 MultiBufferPlan use replacement: consumer %29 -> %29_mb0_ping (multibuffer_true_rewrite_action_0000)
  hivm.hir.vadd ins(%29_mb0_ping, %28 : memref<64xi32, #hivm.address_space<ub>>, i32) outs(%30 : memref<64xi32, #hivm.address_space<ub>>)
  %31 = hivm.hir.pointer_cast(%c148736_i64) : memref<64xi32, #hivm.address_space<ub>>
  // HIVM V5.0 MultiBufferPlan true rewrite: ping slot for %31 (multibuffer_true_rewrite_action_0001)
  %31_mb1_ping = hivm.hir.pointer_cast(%c148736_i64) : memref<64xi32, #hivm.address_space<ub>>
  annotation.mark %31_mb1_ping {hivm.multi_buffer_slot = "ping", hivm.rewrite_action = "multibuffer_true_rewrite_action_0001"} : none
  // HIVM V5.0 MultiBufferPlan true rewrite: pong slot for %31 (multibuffer_true_rewrite_action_0001)
  %31_mb1_pong = hivm.hir.pointer_cast(%c148736_i64) : memref<64xi32, #hivm.address_space<ub>>
  annotation.mark %31_mb1_pong {hivm.multi_buffer_slot = "pong", hivm.rewrite_action = "multibuffer_true_rewrite_action_0001"} : none
  hivm.hir.pipe_barrier[<PIPE_V>]
  // HIVM V5.0 MultiBufferPlan use replacement: producer %31 -> %31_mb1_ping (multibuffer_true_rewrite_action_0001)
  hivm.hir.vmax ins(%30, %27 : memref<64xi32, #hivm.address_space<ub>>, i32) outs(%31_mb1_ping : memref<64xi32, #hivm.address_space<ub>>)
  %32 = hivm.hir.pointer_cast(%c148736_i64) : memref<64xi1, #hivm.address_space<ub>>
  hivm.hir.pipe_barrier[<PIPE_V>]
  // HIVM V5.0 MultiBufferPlan use replacement: consumer %31 -> %31_mb1_ping (multibuffer_true_rewrite_action_0001)
  hivm.hir.vcmp ins(%31_mb1_ping, %30 : memref<64xi32, #hivm.address_space<ub>>, memref<64xi32, #hivm.address_space<ub>>) outs(%32 : memref<64xi1, #hivm.address_space<ub>>)
  ...
  // HIVM V5.0 MultiBufferPlan true rewrite: ping slot for %37 (multibuffer_true_rewrite_action_0002)
  %37_mb2_ping = hivm.hir.pointer_cast(%c57600_i64) : memref<64xi32, #hivm.address_space<ub>>
  annotation.mark %37_mb2_ping {hivm.multi_buffer_slot = "ping", hivm.rewrite_action = "multibuffer_true_rewrite_action_0002"} : none
  // HIVM V5.0 MultiBufferPlan true rewrite: pong slot for %37 (multibuffer_true_rewrite_action_0002)
  %37_mb2_pong = hivm.hir.pointer_cast(%c57600_i64) : memref<64xi32, #hivm.address_space<ub>>
  annotation.mark %37_mb2_pong {hivm.multi_buffer_slot = "pong", hivm.rewrite_action = "multibuffer_true_rewrite_action_0002"} : none
  // HIVM V5.0 MultiBufferPlan use replacement: producer %37 -> %37_mb2_ping (multibuffer_true_rewrite_action_0002)
  hivm.hir.vbrc ins(%36 : i32) outs(%37_mb2_ping : memref<64xi32, #hivm.address_space<ub>>)
  %38 = hivm.hir.pointer_cast(%c57600_i64) : memref<64xi1, #hivm.address_space<ub>>
  hivm.hir.pipe_barrier[<PIPE_V>]
  // HIVM V5.0 MultiBufferPlan use replacement: consumer %37 -> %37_mb2_ping (multibuffer_true_rewrite_action_0002)
  hivm.hir.vcmp ins(%30, %37_mb2_ping : memref<64xi32, #hivm.address_space<ub>>, memref<64xi32, #hivm.address_space<ub>>) outs(%38 : memref<64xi1, #hivm.address_space<ub>>)
  ...
  // HIVM V5.0 MultiBufferPlan true rewrite: ping slot for %56 (multibuffer_true_rewrite_action_0003)
  %56_mb3_ping = hivm.hir.pointer_cast(%c57856_i64) : memref<64xi32, #hivm.address_space<ub>>
  annotation.mark %56_mb3_ping {hivm.multi_buffer_slot = "ping", hivm.rewrite_action = "multibuffer_true_rewrite_action_0003"} : none
  // HIVM V5.0 MultiBufferPlan true rewrite: pong slot for %56 (multibuffer_true_rewrite_action_0003)
  %56_mb3_pong = hivm.hir.pointer_cast(%c57856_i64) : memref<64xi32, #hivm.address_space<ub>>
  annotation.mark %56_mb3_pong {hivm.multi_buffer_slot = "pong", hivm.rewrite_action = "multibuffer_true_rewrite_action_0003"} : none
  // HIVM V5.0 MultiBufferPlan use replacement: producer %56 -> %56_mb3_ping (multibuffer_true_rewrite_action_0003)
  hivm.hir.vmax ins(%30, %c0_i32 : memref<64xi32, #hivm.address_space<ub>>, i32) outs(%56_mb3_ping : memref<64xi32, #hivm.address_space<ub>>)
  %57 = hivm.hir.pointer_cast(%c57856_i64) : memref<64xi1, #hivm.address_space<ub>>
  hivm.hir.pipe_barrier[<PIPE_V>]
  // HIVM V5.0 MultiBufferPlan use replacement: consumer %56 -> %56_mb3_ping (multibuffer_true_rewrite_action_0003)
  hivm.hir.vcmp ins(%56_mb3_ping, %30 : memref<64xi32, #hivm.address_space<ub>>, memref<64xi32, #hivm.address_space<ub>>) outs(%57 : memref<64xi1, #hivm.address_space<ub>>)
  %58 = hivm.hir.pointer_cast(%c57856_i64) : memref<64xi1, #hivm.address_space<ub>>
  // HIVM V5.0 MultiBufferPlan true rewrite: ping slot for %58 (multibuffer_true_rewrite_action_0004)
  %58_mb4_ping = hivm.hir.pointer_cast(%c57856_i64) : memref<64xi1, #hivm.address_space<ub>>
  annotation.mark %58_mb4_ping {hivm.multi_buffer_slot = "ping", hivm.rewrite_action = "multibuffer_true_rewrite_action_0004"} : none
  // HIVM V5.0 MultiBufferPlan true rewrite: pong slot for %58 (multibuffer_true_rewrite_action_0004)
  %58_mb4_pong = hivm.hir.pointer_cast(%c57856_i64) : memref<64xi1, #hivm.address_space<ub>>
  annotation.mark %58_mb4_pong {hivm.multi_buffer_slot = "pong", hivm.rewrite_action = "multibuffer_true_rewrite_action_0004"} : none
  hivm.hir.pipe_barrier[<PIPE_V>]
  // HIVM V5.0 MultiBufferPlan use replacement: producer %58 -> %58_mb4_ping (multibuffer_true_rewrite_action_0004)
  hivm.hir.vand ins(%33, %57 : memref<64xi1, #hivm.address_space<ub>>, memref<64xi1, #hivm.address_space<ub>>) outs(%58_mb4_ping : memref<64xi1, #hivm.address_space<ub>>)
  ...
  // HIVM V5.0 MultiBufferPlan true rewrite: ping slot for %81 (multibuffer_true_rewrite_action_0005)
  %81_mb5_ping = hivm.hir.pointer_cast(%c148992_i64) : memref<32xi32, #hivm.address_space<ub>>
  annotation.mark %81_mb5_ping {hivm.multi_buffer_slot = "ping", hivm.rewrite_action = "multibuffer_true_rewrite_action_0005"} : none
  // HIVM V5.0 MultiBufferPlan true rewrite: pong slot for %81 (multibuffer_true_rewrite_action_0005)
  %81_mb5_pong = hivm.hir.pointer_cast(%c148992_i64) : memref<32xi32, #hivm.address_space<ub>>
  annotation.mark %81_mb5_pong {hivm.multi_buffer_slot = "pong", hivm.rewrite_action = "multibuffer_true_rewrite_action_0005"} : none
  // HIVM V5.0 MultiBufferPlan use replacement: producer %81 -> %81_mb5_ping (multibuffer_true_rewrite_action_0005)
  hivm.hir.varange offset[%c0] strides[%c1] outs(%81_mb5_ping : memref<32xi32, #hivm.address_space<ub>>)
  ...
  hivm.hir.pipe_barrier[<PIPE_V>]
  // HIVM V5.0 MultiBufferPlan use replacement: consumer %58 -> %58_mb4_ping (multibuffer_true_rewrite_action_0004)
  hivm.hir.vcast ins(%58_mb4_ping : memref<64xi1, #hivm.address_space<ub>>) outs(%86 : memref<64xf16, #hivm.address_space<ub>>) temp_buffer(%87 : memref<48xf16, #hivm.address_space<ub>>) round_mode = <trunc>
  ...
  %103:2 = scf.for %arg29 = %c0_i32 to %c4_i32 step %c1_i32 iter_args(%arg30 = %101, %arg31 = %102) -> (memref<64x64xf32, #hivm.address_space<ub>>, memref<64xf32, #hivm.address_space<ub>>)  : i32 {
    ...
    %172:6 = scf.for %arg32 = %c0_i32 to %c4_i32 step %c1_i32 iter_args(%arg33 = %168, %arg34 = %169, %arg35 = %170, %arg36 = %171, %arg37 = %arg30, %arg38 = %arg31) -> (memref<32xf32, #hivm.address_space<ub>>, memref<64x32xf32, #hivm.address_space<ub>>, memref<64x32xf32, #hivm.address_space<ub>>, memref<64x32xf32, #hivm.address_space<ub>>, memref<64x64xf32, #hivm.address_space<ub>>, memref<64xf32, #hivm.address_space<ub>>)  : i32 {
      ...
      hivm.hir.pipe_barrier[<PIPE_V>]
      // HIVM V5.0 MultiBufferPlan use replacement: consumer %81 -> %81_mb5_ping (multibuffer_true_rewrite_action_0005)
      hivm.hir.vadd ins(%81_mb5_ping, %235 : memref<32xi32, #hivm.address_space<ub>>, i32) outs(%236 : memref<32xi32, #hivm.address_space<ub>>)
      %237 = hivm.hir.pointer_cast(%c384_i64) : memref<32xi32, #hivm.address_space<ub>>
      // HIVM V5.0 MultiBufferPlan true rewrite: ping slot for %237 (multibuffer_true_rewrite_action_0006)
      %237_mb6_ping = hivm.hir.pointer_cast(%c384_i64) : memref<32xi32, #hivm.address_space<ub>>
      annotation.mark %237_mb6_ping {hivm.multi_buffer_slot = "ping", hivm.rewrite_action = "multibuffer_true_rewrite_action_0006"} : none
      // HIVM V5.0 MultiBufferPlan true rewrite: pong slot for %237 (multibuffer_true_rewrite_action_0006)
      %237_mb6_pong = hivm.hir.pointer_cast(%c384_i64) : memref<32xi32, #hivm.address_space<ub>>
      annotation.mark %237_mb6_pong {hivm.multi_buffer_slot = "pong", hivm.rewrite_action = "multibuffer_true_rewrite_action_0006"} : none
      hivm.hir.pipe_barrier[<PIPE_V>]
      // HIVM V5.0 MultiBufferPlan use replacement: producer %237 -> %237_mb6_ping (multibuffer_true_rewrite_action_0006)
      hivm.hir.vmax ins(%236, %c128_i32 : memref<32xi32, #hivm.address_space<ub>>, i32) outs(%237_mb6_ping : memref<32xi32, #hivm.address_space<ub>>)
      %238 = hivm.hir.pointer_cast(%c384_i64) : memref<32xi1, #hivm.address_space<ub>>
      hivm.hir.pipe_barrier[<PIPE_V>]
      // HIVM V5.0 MultiBufferPlan use replacement: consumer %237 -> %237_mb6_ping (multibuffer_true_rewrite_action_0006)
      hivm.hir.vcmp ins(%237_mb6_ping, %236 : memref<32xi32, #hivm.address_space<ub>>, memref<32xi32, #hivm.address_space<ub>>) outs(%238 : memref<32xi1, #hivm.address_space<ub>>)
      %239 = hivm.hir.pointer_cast(%c384_i64) : memref<32xi1, #hivm.address_space<ub>>
      // HIVM V5.0 MultiBufferPlan true rewrite: ping slot for %239 (multibuffer_true_rewrite_action_0007)
      %239_mb7_ping = hivm.hir.pointer_cast(%c384_i64) : memref<32xi1, #hivm.address_space<ub>>
      annotation.mark %239_mb7_ping {hivm.multi_buffer_slot = "ping", hivm.rewrite_action = "multibuffer_true_rewrite_action_0007"} : none
      // HIVM V5.0 MultiBufferPlan true rewrite: pong slot for %239 (multibuffer_true_rewrite_action_0007)
      %239_mb7_pong = hivm.hir.pointer_cast(%c384_i64) : memref<32xi1, #hivm.address_space<ub>>
      annotation.mark %239_mb7_pong {hivm.multi_buffer_slot = "pong", hivm.rewrite_action = "multibuffer_true_rewrite_action_0007"} : none
      hivm.hir.pipe_barrier[<PIPE_V>]
      // HIVM V5.0 MultiBufferPlan use replacement: producer %239 -> %239_mb7_ping (multibuffer_true_rewrite_action_0007)
      hivm.hir.vnot ins(%238 : memref<32xi1, #hivm.address_space<ub>>) outs(%239_mb7_ping : memref<32xi1, #hivm.address_space<ub>>)
      %240 = hivm.hir.pointer_cast(%c512_i64) : memref<32xi32, #hivm.address_space<ub>>
      // HIVM V5.0 MultiBufferPlan true rewrite: ping slot for %240 (multibuffer_true_rewrite_action_0008)
      %240_mb8_ping = hivm.hir.pointer_cast(%c512_i64) : memref<32xi32, #hivm.address_space<ub>>
      annotation.mark %240_mb8_ping {hivm.multi_buffer_slot = "ping", hivm.rewrite_action = "multibuffer_true_rewrite_action_0008"} : none
      // HIVM V5.0 MultiBufferPlan true rewrite: pong slot for %240 (multibuffer_true_rewrite_action_0008)
      %240_mb8_pong = hivm.hir.pointer_cast(%c512_i64) : memref<32xi32, #hivm.address_space<ub>>
      annotation.mark %240_mb8_pong {hivm.multi_buffer_slot = "pong", hivm.rewrite_action = "multibuffer_true_rewrite_action_0008"} : none
      // HIVM V5.0 MultiBufferPlan use replacement: producer %240 -> %240_mb8_ping (multibuffer_true_rewrite_action_0008)
      hivm.hir.vmax ins(%236, %c0_i32 : memref<32xi32, #hivm.address_space<ub>>, i32) outs(%240_mb8_ping : memref<32xi32, #hivm.address_space<ub>>)
      %241 = hivm.hir.pointer_cast(%c512_i64) : memref<32xi1, #hivm.address_space<ub>>
      hivm.hir.pipe_barrier[<PIPE_V>]
      // HIVM V5.0 MultiBufferPlan use replacement: consumer %240 -> %240_mb8_ping (multibuffer_true_rewrite_action_0008)
      hivm.hir.vcmp ins(%240_mb8_ping, %236 : memref<32xi32, #hivm.address_space<ub>>, memref<32xi32, #hivm.address_space<ub>>) outs(%241 : memref<32xi1, #hivm.address_space<ub>>)
      %242 = hivm.hir.pointer_cast(%c384_i64) : memref<32xi1, #hivm.address_space<ub>>
      hivm.hir.pipe_barrier[<PIPE_V>]
      // HIVM V5.0 MultiBufferPlan use replacement: consumer %239 -> %239_mb7_ping (multibuffer_true_rewrite_action_0007)
      hivm.hir.vand ins(%239_mb7_ping, %241 : memref<32xi1, #hivm.address_space<ub>>, memref<32xi1, #hivm.address_space<ub>>) outs(%242 : memref<32xi1, #hivm.address_space<ub>>)
      ...
      scf.for %arg39 = %99 to %100 step %c1 {
        ...
        scf.for %arg40 = %274 to %275 step %c1 {
          ...
          // HIVM V5.0 MultiBufferPlan use replacement: consumer %313 -> %313_mb9_ping (multibuffer_true_rewrite_action_0009)
          %313_mb9_ping = memref.load %reinterpret_cast_168[%c0] : memref<1xbf16, strided<[1], offset: ?>, #hivm.address_space<gm>>
          // HIVM V5.0 MultiBufferPlan use replacement: producer %313 -> %313_mb9_ping (multibuffer_true_rewrite_action_0009)
          memref.store %313_mb9_ping, %276[%arg39, %arg40] : memref<64x32xbf16, #hivm.address_space<ub>>
        } {ExtractedLoadOrStore}
      } {ExtractedLoadOrStore}
      ...
      %300:2 = scf.if %165 -> (memref<64x64xf32, #hivm.address_space<ub>>, memref<64xf32, #hivm.address_space<ub>>) {
        ...
        // HIVM V5.0 MultiBufferPlan true rewrite: ping slot for %313 (multibuffer_true_rewrite_action_0009)
        %313_mb9_ping = hivm.hir.pointer_cast(%c98688_i64) : memref<64x32xf32, #hivm.address_space<ub>>
        annotation.mark %313_mb9_ping {hivm.multi_buffer_slot = "ping", hivm.rewrite_action = "multibuffer_true_rewrite_action_0009"} : none
        // HIVM V5.0 MultiBufferPlan true rewrite: pong slot for %313 (multibuffer_true_rewrite_action_0009)
        %313_mb9_pong = hivm.hir.pointer_cast(%c98688_i64) : memref<64x32xf32, #hivm.address_space<ub>>
        annotation.mark %313_mb9_pong {hivm.multi_buffer_slot = "pong", hivm.rewrite_action = "multibuffer_true_rewrite_action_0009"} : none
    ...
    // HIVM V5.0 MultiBufferPlan true rewrite: ping slot for %177 (multibuffer_true_rewrite_action_0010)
    %177_mb10_ping = hivm.hir.pointer_cast(%c61824_i64) : memref<32xf32, #hivm.address_space<ub>>
    annotation.mark %177_mb10_ping {hivm.multi_buffer_slot = "ping", hivm.rewrite_action = "multibuffer_true_rewrite_action_0010"} : none
    // HIVM V5.0 MultiBufferPlan true rewrite: pong slot for %177 (multibuffer_true_rewrite_action_0010)
    %177_mb10_pong = hivm.hir.pointer_cast(%c61824_i64) : memref<32xf32, #hivm.address_space<ub>>
    annotation.mark %177_mb10_pong {hivm.multi_buffer_slot = "pong", hivm.rewrite_action = "multibuffer_true_rewrite_action_0010"} : none
    // HIVM V5.0 MultiBufferPlan use replacement: producer %177 -> %177_mb10_ping (multibuffer_true_rewrite_action_0010)
    hivm.hir.vmul ins(%164, %cst_2 : memref<32xf32, #hivm.address_space<ub>>, f32) outs(%177_mb10_ping : memref<32xf32, #hivm.address_space<ub>>)
    %178 = hivm.hir.pointer_cast(%c61824_i64) : memref<32xf32, #hivm.address_space<ub>>
    hivm.hir.pipe_barrier[<PIPE_V>]
    // HIVM V5.0 MultiBufferPlan use replacement: consumer %177 -> %177_mb10_ping (multibuffer_true_rewrite_action_0010)
    hivm.hir.vexp ins(%177_mb10_ping : memref<32xf32, #hivm.address_space<ub>>) outs(%178 : memref<32xf32, #hivm.address_space<ub>>)
    %179 = hivm.hir.pointer_cast(%c61824_i64) : memref<32xf32, #hivm.address_space<ub>>
    // HIVM V5.0 MultiBufferPlan true rewrite: ping slot for %179 (multibuffer_true_rewrite_action_0011)
    %179_mb11_ping = hivm.hir.pointer_cast(%c61824_i64) : memref<32xf32, #hivm.address_space<ub>>
    annotation.mark %179_mb11_ping {hivm.multi_buffer_slot = "ping", hivm.rewrite_action = "multibuffer_true_rewrite_action_0011"} : none
    // HIVM V5.0 MultiBufferPlan true rewrite: pong slot for %179 (multibuffer_true_rewrite_action_0011)
    %179_mb11_pong = hivm.hir.pointer_cast(%c61824_i64) : memref<32xf32, #hivm.address_space<ub>>
    annotation.mark %179_mb11_pong {hivm.multi_buffer_slot = "pong", hivm.rewrite_action = "multibuffer_true_rewrite_action_0011"} : none
    hivm.hir.pipe_barrier[<PIPE_V>]
    // HIVM V5.0 MultiBufferPlan use replacement: producer %179 -> %179_mb11_ping (multibuffer_true_rewrite_action_0011)
    hivm.hir.vmul ins(%172#0, %178 : memref<32xf32, #hivm.address_space<ub>>, memref<32xf32, #hivm.address_space<ub>>) outs(%179_mb11_ping : memref<32xf32, #hivm.address_space<ub>>)
    ...
    hivm.hir.pipe_barrier[<PIPE_V>]
    // HIVM V5.0 MultiBufferPlan use replacement: consumer %179 -> %179_mb11_ping (multibuffer_true_rewrite_action_0011)
    hivm.hir.vadd ins(%179_mb11_ping, %collapse_shape_105 : memref<32xf32, #hivm.address_space<ub>>, memref<32xf32, #hivm.address_space<ub>>) outs(%223 : memref<32xf32, #hivm.address_space<ub>>)
