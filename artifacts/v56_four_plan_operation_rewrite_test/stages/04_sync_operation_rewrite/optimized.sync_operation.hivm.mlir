module {
  ...
  func.func @fa(%Q_gm : memref<64x128xf16, #hivm.address_space<gm>>, %K_gm : memref<1024x128xf16, #hivm.address_space<gm>>, %V_gm : memref<1024x128xf16, #hivm.address_space<gm>>, %O_gm : memref<64x128xf16, #hivm.address_space<gm>>) {
    ...
    // HIVM V5.0 MultiBufferPlan true rewrite: ping slot for %p_ub (multibuffer_true_rewrite_action_0002)
    %p_ub_mb2_ping = memref.alloc() : memref<32x64xf16, #hivm.address_space<ub>
    annotation.mark %p_ub_mb2_ping {hivm.multi_buffer_slot = "ping", hivm.rewrite_action = "multibuffer_true_rewrite_action_0002"} : memref<32x64xf16, #hivm.address_space<ub>
    // HIVM V5.0 MultiBufferPlan true rewrite: pong slot for %p_ub (multibuffer_true_rewrite_action_0002)
    %p_ub_mb2_pong = memref.alloc() : memref<32x64xf16, #hivm.address_space<ub>
    annotation.mark %p_ub_mb2_pong {hivm.multi_buffer_slot = "pong", hivm.rewrite_action = "multibuffer_true_rewrite_action_0002"} : memref<32x64xf16, #hivm.address_space<ub>
    ...
    // HIVM V5.1 CVPipelinePlan slot binding: %k_ub -> %k_ub_mb3_ping (cvpipeline_true_rewrite_action_0000)
    %k_ub_mb3_ping = memref.alloc() : memref<64x128xf16, #hivm.address_space<ub>
    // HIVM V5.0 MultiBufferPlan true rewrite: ping slot for %k_ub (multibuffer_true_rewrite_action_0003)
    %k_ub_mb3_ping = memref.alloc() : memref<64x128xf16, #hivm.address_space<ub>
    annotation.mark %k_ub_mb3_ping {hivm.multi_buffer_slot = "ping", hivm.rewrite_action = "multibuffer_true_rewrite_action_0003"} : memref<64x128xf16, #hivm.address_space<ub>
    // HIVM V5.0 MultiBufferPlan true rewrite: pong slot for %k_ub (multibuffer_true_rewrite_action_0003)
    // HIVM V5.1 CVPipelinePlan slot binding: %k_ub -> %k_ub_mb3_ping (cvpipeline_true_rewrite_action_0000)
    %k_ub_mb3_pong = memref.alloc() : memref<64x128xf16, #hivm.address_space<ub>
    annotation.mark %k_ub_mb3_pong {hivm.multi_buffer_slot = "pong", hivm.rewrite_action = "multibuffer_true_rewrite_action_0003"} : memref<64x128xf16, #hivm.address_space<ub>
      ...
      scf.for %k_outer = %c0 to %cK step %c128 {   // HIVM V5.6 TilingPlan K-tile loop
        scf.for %n_outer = %c0 to %cN step %c64 {   // HIVM V5.6 TilingPlan N-tile loop
          ...
          scf.for %j = %c0 to %cE step %cB {   // @trip=10
            ...
            // HIVM V5.0 MultiBufferPlan use replacement: producer %k_ub -> %k_ub_mb3_ping (multibuffer_true_rewrite_action_0003)
            hivm.hir.load ins(%K_gm : memref<1024x128xf16, #hivm.address_space<gm>>) outs(%k_ub_mb3_ping : memref<64x128xf16, #hivm.address_space<ub>)
            ...
            // HIVM V5.0 MultiBufferPlan use replacement: consumer %k_ub -> %k_ub_mb3_ping (multibuffer_true_rewrite_action_0003)
            hivm.hir.nd2nz ins(%k_ub_mb3_ping : memref<64x128xf16, #hivm.address_space<ub>) outs(%k_l1_ping : memref<64x128xf16, #hivm.address_space<cbuf>)
            ...
            // HIVM V5.5 SyncPlan operation rewrite: normalized wait_flag pipe/event attrs from line 91
    ...
    // HIVM V5.1 CVPipelinePlan group end: cvpipeline_true_rewrite_action_0000
            ...
            hivm.hir.vreduce ins(%s_ub_mb1_ping : memref<32x1xf16, #hivm.address_space<ub>) {reduce_op="max"}
            // HIVM V5.5 TilingPlan shape rewrite on line 37: %p_ub [64, 96] -> [32, 64]
            // HIVM V5.0 MultiBufferPlan use replacement: producer %p_ub -> %p_ub_mb2_ping (multibuffer_true_rewrite_action_0002)
            hivm.hir.vsub ins(%s_ub, %m_ub : memref<32x1xf16, #hivm.address_space<ub>) outs(%p_ub_mb2_ping : memref<32x64xf16, #hivm.address_space<ub>)
            // HIVM V5.5 TilingPlan shape rewrite on line 38: %p_ub [64, 96] -> [32, 64]
            // HIVM V5.0 MultiBufferPlan use replacement: consumer %p_ub -> %p_ub_mb2_ping (multibuffer_true_rewrite_action_0002)
            hivm.hir.vexp ins(%p_ub_mb2_ping : memref<32x64xf16, #hivm.address_space<ub>) outs(%p_ub_mb2_ping : memref<32x64xf16, #hivm.address_space<ub>)
            ...
            //   restricted=true operation_movement=false loop_skewing=false
            hivm.hir.nd2nz ins(%p_ub : memref<32x64xf16, #hivm.address_space<ub>)
            ...
            hivm.hir.mmad ins(%p_ub, %v_l1 : memref<32x64xf16, #hivm.address_space<ub>)
            ...
            // HIVM V5.5 SyncPlan operation rewrite: normalized set_flag pipe/event attrs from line 132
