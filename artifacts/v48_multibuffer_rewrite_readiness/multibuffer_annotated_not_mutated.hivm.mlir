...
// HIVM V4.8 MultiBufferPlan candidate: multibuffer_plan_action_0005 risk=LOW readiness=READY_FOR_GUARDED_PLAN
//   target=%12 scope=UB rewrite=planned_not_mutated
...
// HIVM V4.8 MultiBufferPlan candidate: multibuffer_plan_action_0011 risk=LOW readiness=READY_FOR_GUARDED_PLAN
//   target=%29 scope=UB rewrite=planned_not_mutated
...
// HIVM V4.8 MultiBufferPlan candidate: multibuffer_plan_action_0012 risk=LOW readiness=READY_FOR_GUARDED_PLAN
//   target=%31 scope=UB rewrite=planned_not_mutated
...
// HIVM V4.8 MultiBufferPlan candidate: multibuffer_plan_action_0013 risk=LOW readiness=READY_FOR_GUARDED_PLAN
//   target=%32 scope=UB rewrite=planned_not_mutated
...
// HIVM V4.8 MultiBufferPlan candidate: multibuffer_plan_action_0003 risk=LOW readiness=READY_FOR_GUARDED_PLAN
//   target=%37 scope=UB rewrite=planned_not_mutated
...
// HIVM V4.8 MultiBufferPlan candidate: multibuffer_plan_action_0014 risk=LOW readiness=READY_FOR_GUARDED_PLAN
//   target=%38 scope=UB rewrite=planned_not_mutated
...
// HIVM V4.8 MultiBufferPlan candidate: multibuffer_plan_action_0015 risk=LOW readiness=READY_FOR_GUARDED_PLAN
//   target=%56 scope=UB rewrite=planned_not_mutated
...
// HIVM V4.8 MultiBufferPlan candidate: multibuffer_plan_action_0016 risk=LOW readiness=READY_FOR_GUARDED_PLAN
//   target=%57 scope=UB rewrite=planned_not_mutated
...
// HIVM V4.8 MultiBufferPlan candidate: multibuffer_plan_action_0017 risk=LOW readiness=READY_FOR_GUARDED_PLAN
//   target=%58 scope=UB rewrite=planned_not_mutated
...
// HIVM V4.8 MultiBufferPlan candidate: multibuffer_plan_action_0006 risk=LOW readiness=READY_FOR_GUARDED_PLAN
//   target=%73 scope=UB rewrite=planned_not_mutated
  ...
  hivm.hir.sync_block_set[<VECTOR>, <PIPE_MTE3>, <PIPE_S>] flag = 1
  annotation.mark %73 {MayImplicitTransposeWithLastAxis} : memref<64x64xbf16, #hivm.address_space<ub>>
// HIVM V4.8 MultiBufferPlan candidate: multibuffer_plan_action_0018 risk=LOW readiness=READY_FOR_GUARDED_PLAN
//   target=%81 scope=UB rewrite=planned_not_mutated
...
// HIVM V4.8 MultiBufferPlan candidate: multibuffer_plan_action_0001 risk=LOW readiness=READY_FOR_GUARDED_PLAN
//   target=%89 scope=UB rewrite=planned_not_mutated
...
// HIVM V4.8 MultiBufferPlan candidate: multibuffer_plan_action_0002 risk=LOW readiness=READY_FOR_GUARDED_PLAN
//   target=%236 scope=UB rewrite=planned_not_mutated
...
// HIVM V4.8 MultiBufferPlan candidate: multibuffer_plan_action_0019 risk=LOW readiness=READY_FOR_GUARDED_PLAN
//   target=%237 scope=UB rewrite=planned_not_mutated
...
// HIVM V4.8 MultiBufferPlan candidate: multibuffer_plan_action_0007 risk=LOW readiness=READY_FOR_GUARDED_PLAN
//   target=%269 scope=UB rewrite=planned_not_mutated
      ...
      hivm.hir.sync_block_set[<VECTOR>, <PIPE_MTE3>, <PIPE_S>] flag = 1
// HIVM V4.8 MultiBufferPlan candidate: multibuffer_plan_action_0008 risk=LOW readiness=READY_FOR_GUARDED_PLAN
//   target=%272 scope=UB rewrite=planned_not_mutated
...
// HIVM V4.8 MultiBufferPlan candidate: multibuffer_plan_action_0009 risk=LOW readiness=READY_FOR_GUARDED_PLAN
//   target=%276 scope=UB rewrite=planned_not_mutated
      ...
      %300:2 = scf.if %165 -> (memref<64x64xf32, #hivm.address_space<ub>>, memref<64xf32, #hivm.address_space<ub>>) {
        ...
        hivm.hir.set_flag[<PIPE_MTE2>, <PIPE_V>, <EVENT_ID0>]
// HIVM V4.8 MultiBufferPlan candidate: multibuffer_plan_action_0000 risk=LOW readiness=READY_FOR_GUARDED_PLAN
//   target=%313 scope=UB rewrite=planned_not_mutated
...
// HIVM V4.8 MultiBufferPlan candidate: multibuffer_plan_action_0010 risk=LOW readiness=READY_FOR_GUARDED_PLAN
//   target=%129 scope=UB rewrite=planned_not_mutated
...
// HIVM V4.8 MultiBufferPlan candidate: multibuffer_plan_action_0004 risk=LOW readiness=READY_FOR_GUARDED_PLAN
//   target=%130 scope=UB rewrite=planned_not_mutated
